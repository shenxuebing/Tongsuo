...
/* 获取SKF函数指针 */
static void setFunctionList(HMODULE  hCT32, SK_FUNCTION_LIST_PTR pList, UINT4 iGetProcAddressID)
{
	//=====================================设备管理============================================//
	pList->SKF_WaitForDevEvent = (_CP_SKF_WaitForDevEvent*)DLSYM(hCT32, "SKF_WaitForDevEvent");
	pList->SKF_CancelWaitForDevEvent = (_CP_SKF_CancelWaitForDevEvent*)DLSYM(hCT32, "SKF_CancelWaitForDevEvent");
	...
	pList->SKF_DisConnectDev = (_CP_SKF_DisConnectDev*)DLSYM(hCT32, "SKF_DisConnectDev");
	pList->SKF_GetDevState = (_CP_SKF_GetDevState*)DLSYM(hCT32, "SKF_GetDevState");
	...
	//=====================================访问控制============================================//
	pList->SKF_ChangeDevAuthKey = (_CP_SKF_ChangeDevAuthKey*)DLSYM(hCT32, "SKF_ChangeDevAuthKey");
	...
	pList->SKF_ClearSecureState = (_CP_SKF_ClearSecureState*)DLSYM(hCT32, "SKF_ClearSecureState");
	//=====================================应用管理============================================//
	pList->SKF_CreateApplication = (_CP_SKF_CreateApplication*)DLSYM(hCT32, "SKF_CreateApplication");
	pList->SKF_EnumApplication = (_CP_SKF_EnumApplication*)DLSYM(hCT32, "SKF_EnumApplication");
	pList->SKF_DeleteApplication = (_CP_SKF_DeleteApplication*)DLSYM(hCT32, "SKF_DeleteApplication");
	pList->SKF_OpenApplication = (_CP_SKF_OpenApplication*)DLSYM(hCT32, "SKF_OpenApplication");
	pList->SKF_CloseApplication = (_CP_SKF_CloseApplication*)DLSYM(hCT32, "SKF_CloseApplication");
	//=====================================文件管理============================================//
	...
	pList->SKF_GetFileInfo = (_CP_SKF_GetFileInfo*)DLSYM(hCT32, "SKF_GetFileInfo");
	...
	//=====================================容器管理============================================//
	pList->SKF_CreateContainer = (_CP_SKF_CreateContainer*)DLSYM(hCT32, "SKF_CreateContainer");
	pList->SKF_DeleteContainer = (_CP_SKF_DeleteContainer*)DLSYM(hCT32, "SKF_DeleteContainer");
	pList->SKF_OpenContainer = (_CP_SKF_OpenContainer*)DLSYM(hCT32, "SKF_OpenContainer");
	pList->SKF_CloseContainer = (_CP_SKF_CloseContainer*)DLSYM(hCT32, "SKF_CloseContainer");
	pList->SKF_EnumContainer = (_CP_SKF_EnumContainer*)DLSYM(hCT32, "SKF_EnumContainer");
	pList->SKF_GetContainerType = (_CP_SKF_GetContainerType*)DLSYM(hCT32, "SKF_GetContainerType");
	pList->SKF_ImportCertificate = (_CP_SKF_ImportCertificate*)DLSYM(hCT32, "SKF_ImportCertificate");
	pList->SKF_ExportCertificate = (_CP_SKF_ExportCertificate*)DLSYM(hCT32, "SKF_ExportCertificate");
	//=====================================密码服务============================================//
	pList->SKF_GenRandom = (_CP_SKF_GenRandom*)DLSYM(hCT32, "SKF_GenRandom");
	pList->SKF_GenRSAKeyPair = (_CP_SKF_GenRSAKeyPair*)DLSYM(hCT32, "SKF_GenRSAKeyPair");
	pList->SKF_ImportRSAKeyPair = (_CP_SKF_ImportRSAKeyPair*)DLSYM(hCT32, "SKF_ImportRSAKeyPair");
	pList->SKF_RSASignData = (_CP_SKF_RSASignData*)DLSYM(hCT32, "SKF_RSASignData");
	pList->SKF_RSAVerify = (_CP_SKF_RSAVerify*)DLSYM(hCT32, "SKF_RSAVerify");
	pList->SKF_RSAExportSessionKey = (_CP_SKF_RSAExportSessionKey*)DLSYM(hCT32, "SKF_RSAExportSessionKey");
	pList->SKF_GenECCKeyPair = (_CP_SKF_GenECCKeyPair*)DLSYM(hCT32, "SKF_GenECCKeyPair");
	pList->SKF_ImportECCKeyPair = (_CP_SKF_ImportECCKeyPair*)DLSYM(hCT32, "SKF_ImportECCKeyPair");
	pList->SKF_ECCSignData = (_CP_SKF_ECCSignData*)DLSYM(hCT32, "SKF_ECCSignData");
	pList->SKF_ECCVerify = (_CP_SKF_ECCVerify*)DLSYM(hCT32, "SKF_ECCVerify");
	pList->SKF_ECCExportSessionKey = (_CP_SKF_ECCExportSessionKey*)DLSYM(hCT32, "SKF_ECCExportSessionKey");
	pList->SKF_ExtECCEncrypt = (_CP_SKF_ExtECCEncrypt*)DLSYM(hCT32, "SKF_ExtECCEncrypt");
	pList->SKF_ExtECCDecrypt = (_CP_SKF_ExtECCDecrypt*)DLSYM(hCT32, "SKF_ExtECCDecrypt");
	pList->SKF_ExtECCSign = (_CP_SKF_ExtECCSign*)DLSYM(hCT32, "SKF_ExtECCSign");
	pList->SKF_GenerateAgreementDataWithECC = (_CP_SKF_GenerateAgreementDataWithECC*)DLSYM(hCT32, "SKF_GenerateAgreementDataWithECC");
	pList->SKF_GenerateAgreementDataAndKeyWithECC = (_CP_SKF_GenerateAgreementDataAndKeyWithECC*)DLSYM(hCT32, "SKF_GenerateAgreementDataAndKeyWithECC");
	pList->SKF_GenerateKeyWithECC = (_CP_SKF_GenerateKeyWithECC*)DLSYM(hCT32, "SKF_GenerateKeyWithECC");
	pList->SKF_ExportPublicKey = (_CP_SKF_ExportPublicKey*)DLSYM(hCT32, "SKF_ExportPublicKey");
	pList->SKF_ImportSessionKey = (_CP_SKF_ImportSessionKey*)DLSYM(hCT32, "SKF_ImportSessionKey");
	pList->SKF_EncryptInit = (_CP_SKF_EncryptInit*)DLSYM(hCT32, "SKF_EncryptInit");
	pList->SKF_Encrypt = (_CP_SKF_Encrypt*)DLSYM(hCT32, "SKF_Encrypt");
	pList->SKF_EncryptUpdate = (_CP_SKF_EncryptUpdate*)DLSYM(hCT32, "SKF_EncryptUpdate");
	pList->SKF_EncryptFinal = (_CP_SKF_EncryptFinal*)DLSYM(hCT32, "SKF_EncryptFinal");
	pList->SKF_DecryptInit = (_CP_SKF_DecryptInit*)DLSYM(hCT32, "SKF_DecryptInit");
	pList->SKF_Decrypt = (_CP_SKF_Decrypt*)DLSYM(hCT32, "SKF_Decrypt");
	pList->SKF_DecryptUpdate = (_CP_SKF_DecryptUpdate*)DLSYM(hCT32, "SKF_DecryptUpdate");
	pList->SKF_DecryptFinal = (_CP_SKF_DecryptFinal*)DLSYM(hCT32, "SKF_DecryptFinal");
	pList->SKF_DigestInit = (_CP_SKF_DigestInit*)DLSYM(hCT32, "SKF_DigestInit");
	pList->SKF_Digest = (_CP_SKF_Digest*)DLSYM(hCT32, "SKF_Digest");
	pList->SKF_DigestUpdate = (_CP_SKF_DigestUpdate*)DLSYM(hCT32, "SKF_DigestUpdate");
	pList->SKF_DigestFinal = (_CP_SKF_DigestFinal*)DLSYM(hCT32, "SKF_DigestFinal");
	...
	pList->SKF_CloseHandle = (_CP_SKF_CloseHandle*)DLSYM(hCT32, "SKF_CloseHandle");
	//=================================应用扩展接口=====================================//
	pList->SKF_SetSymmKey = (_CP_SKF_SetSymmKey*)DLSYM(hCT32, "SKF_SetSymmKey");
	pList->SKF_ImportCACertificate = (_CP_SKF_ImportCACertificate*)DLSYM(hCT32, "SKF_ImportCACertificate");
	pList->SKF_ExportCACertificate = (_CP_SKF_ExportCACertificate*)DLSYM(hCT32, "SKF_ExportCACertificate");
	pList->SKF_ImportECCKeyPair2 = (_CP_SKF_ImportECCKeyPair2*)DLSYM(hCT32, "SKF_ImportECCKeyPair2");
	if (iGetProcAddressID & 0x1)
	{
		pList->SKF_RSADecryptA = (_CP_SKF_RSADecryptA*)DLSYM(hCT32, "SKF_RSADecrypt");
	}
	else if (iGetProcAddressID & 0x2)
	{
		pList->SKF_RSADecryptB = (_CP_SKF_RSADecryptB*)DLSYM(hCT32, "SKF_RSADecrypt");
	}
	else
	{
		pList->SKF_RSADecrypt = (_CP_SKF_RSADecrypt*)DLSYM(hCT32, "SKF_RSADecrypt");
	}
	if (iGetProcAddressID & 0x1)
	{
		pList->SKF_ECCDecryptA = (_CP_SKF_ECCDecryptA*)DLSYM(hCT32, "SKF_ECCDecrypt");
	}
	else if (iGetProcAddressID & 0x2)
	{
		pList->SKF_ECCDecryptB = (_CP_SKF_ECCDecryptB*)DLSYM(hCT32, "SKF_ECCDecrypt");
	}
	else
	{
		pList->SKF_ECCDecrypt = (_CP_SKF_ECCDecrypt*)DLSYM(hCT32, "SKF_ECCDecrypt");
	}
	//=================================电子印章扩展接口=====================================//
	pList->EPS_ImportSymmKey = (_CP_EPS_ImportSymmKey*)DLSYM(hCT32, "EPS_ImportSymmKey");
	pList->EPS_WriteESealData = (_CP_EPS_WriteESealData*)DLSYM(hCT32, "EPS_WriteESealData");
	pList->EPS_ReadESealData = (_CP_EPS_ReadESealData*)DLSYM(hCT32, "EPS_ReadESealData");
	...
	pList->SLF_InitDevToken = (_CP_SLF_InitDevToken*)DLSYM(hCT32, "SLF_InitDevToken");
	pList->SLF_SetInitStyle = (_CP_SLF_SetInitStyle*)DLSYM(hCT32, "SLF_SetInitStyle");
	pList->SLF_SetLogFilePath = (_CP_SLF_SetLogFilePath*)DLSYM(hCT32, "SLF_SetLogFilePath");
	pList->SLF_SetSymmSFID = (_CP_SLF_SetSymmSFID*)DLSYM(hCT32, "SLF_SetSymmSFID");
	pList->SLF_RSASignData = (_CP_SLF_RSASignData*)DLSYM(hCT32, "SLF_RSASignData");
	pList->SLF_GenRSAKeyPair = (_CP_SLF_GenRSAKeyPair*)DLSYM(hCT32, "SLF_GenRSAKeyPair");
	pList->SLF_UpdateKeyUsage = (_CP_SLF_UpdateKeyUsage*)DLSYM(hCT32, "SLF_UpdateKeyUsage");
	pList->SLF_SetKeyIDAttribute = (_CP_SLF_SetKeyIDAttribute*)DLSYM(hCT32, "SLF_SetKeyIDAttribute");
...
static int skf_load_library(SKF_CTX* ctx)
{
	...
	/* 检查必要的函数 */
	if (!ctx->skfList.SKF_EnumDev || !ctx->skfList.SKF_ConnectDev || !ctx->skfList.SKF_OpenApplication) {
		SKFerr(0, 2);
		return 0;
	}
...
static int skf_init_device(SKF_CTX* ctx)
{
	...
	if (ctx->app_name && ctx->hDev) {
		ret = ctx->skfList.SKF_OpenApplication(ctx->hDev, ctx->app_name, &ctx->hApplication);
		if (ret != SAR_OK) {
			SKFerr(0, ret);
			return ret;
		}
	...
	if (ctx->user_pin && ctx->hApplication) {
		...
		ret = ctx->skfList.SKF_VerifyPIN(ctx->hApplication, 1, ctx->user_pin, &retry_count);
		if (ret != SAR_OK) {
			SKFerr(0, 8);
			/* 继续执行，某些操作可能不需要认证 */
		}
...
static int skf_enum_containers(SKF_CTX* ctx, char** container_list)
{
	...
	*container_list = NULL;
	...
	/* 枚举容器 */
	ret = ctx->skfList.SKF_EnumContainer(ctx->hApplication, containers, &containers_len);
	if (ret != SAR_OK) {
		if (ret == SAR_BUFFER_TOO_SMALL) {
			/* 缓冲区太小，尝试更大的缓冲区 */
			...
			ret = ctx->skfList.SKF_EnumContainer(ctx->hApplication, large_buf, &containers_len);
			if (ret == SAR_OK) {
	...
	unsigned char* sigret, unsigned int* siglen, const RSA* rsa)
{
	...
	/* 调用 SKF RSA 签名 */
	ret = ctx->skfList.SKF_RSASignData(key_ctx->hContainer, (unsigned char*)m, m_len,
		sigret, &output_len);
	...
	unsigned char* to, RSA* rsa, int padding)
{
	...
	/* 调用 SKF RSA 私钥运算 */
	ret = ctx->skfList.SKF_RSADecrypt(key_ctx->hContainer,
	...
	const BIGNUM* r, EC_KEY* eckey)
{
	...
	/* 调用 SKF ECC 签名 */
	ret = ctx->skfList.SKF_ECCSignData(key_ctx->hContainer, (unsigned char*)dgst, dgst_len, &ecc_sig);
	...
	BIGNUM* bn_r = BN_bin2bn(ecc_sig.r + 32, ECC_MAX_XCOORDINATE_BITS_LEN / 8, NULL);
	BIGNUM* bn_s = BN_bin2bn(ecc_sig.s + 32, ECC_MAX_XCOORDINATE_BITS_LEN / 8, NULL);
	...
	UI_METHOD* ui_method, void* callback_data)
{
	...
	/* 打开容器 */
	ret = ctx->skfList.SKF_OpenContainer(ctx->hApplication, container_name, &hContainer);
	if (ret != SAR_OK) {
		skf_unlock(ctx);
	...
	if (key_type == 0) {  /* RSA */
		...
		ret = ctx->skfList.SKF_ExportPublicKey(hContainer, is_sign_key, blob_data, &blob_len);
		if (ret != SAR_OK) {
			skf_unlock(ctx);
