...
SM2_CERTS_DIR="${SM2_CERTS_DIR:-$CERTS/sm2}"
SM2_SIGN_CERT="${SM2_SIGN_CERT:-$SM2_CERTS_DIR/sm2_server_sign.crt}"
SM2_SIGN_KEY="${SM2_SIGN_KEY:-$SM2_CERTS_DIR/sm2_server_sign.key}"
SM2_ENC_CERT="${SM2_ENC_CERT:-$SM2_CERTS_DIR/sm2_server_enc.crt}"
SM2_ENC_KEY="${SM2_ENC_KEY:-$SM2_CERTS_DIR/sm2_server_enc.key}"
SM2_CAFILE="${SM2_CAFILE:-$SM2_CERTS_DIR/sm2_chain-ca.crt}"
...
RSA1024_SIGN_CERT="${RSA1024_SIGN_CERT:-$RSA_CERTS_DIR/rsa1024_sign.crt}"
RSA1024_SIGN_KEY="${RSA1024_SIGN_KEY:-$RSA_CERTS_DIR/rsa1024_sign.key}"
RSA1024_ENC_CERT="${RSA1024_ENC_CERT:-$RSA_CERTS_DIR/rsa1024_enc.crt}"
RSA1024_ENC_KEY="${RSA1024_ENC_KEY:-$RSA_CERTS_DIR/rsa1024_enc.key}"

RSA2048_SIGN_CERT="${RSA2048_SIGN_CERT:-$RSA_CERTS_DIR/rsa2048_sign.crt}"
RSA2048_SIGN_KEY="${RSA2048_SIGN_KEY:-$RSA_CERTS_DIR/rsa2048_sign.key}"
RSA2048_ENC_CERT="${RSA2048_ENC_CERT:-$RSA_CERTS_DIR/rsa2048_enc.crt}"
RSA2048_ENC_KEY="${RSA2048_ENC_KEY:-$RSA_CERTS_DIR/rsa2048_enc.key}"

RSA3072_SIGN_CERT="${RSA3072_SIGN_CERT:-$RSA_CERTS_DIR/rsa3072_sign.crt}"
RSA3072_SIGN_KEY="${RSA3072_SIGN_KEY:-$RSA_CERTS_DIR/rsa3072_sign.key}"
RSA3072_ENC_CERT="${RSA3072_ENC_CERT:-$RSA_CERTS_DIR/rsa3072_enc.crt}"
RSA3072_ENC_KEY="${RSA3072_ENC_KEY:-$RSA_CERTS_DIR/rsa3072_enc.key}"

RSA4096_SIGN_CERT="${RSA4096_SIGN_CERT:-$RSA_CERTS_DIR/rsa4096_sign.crt}"
RSA4096_SIGN_KEY="${RSA4096_SIGN_KEY:-$RSA_CERTS_DIR/rsa4096_sign.key}"
RSA4096_ENC_CERT="${RSA4096_ENC_CERT:-$RSA_CERTS_DIR/rsa4096_enc.crt}"
RSA4096_ENC_KEY="${RSA4096_ENC_KEY:-$RSA_CERTS_DIR/rsa4096_enc.key}"
