...
RSA_SIGN_KEY="${RSA_SIGN_KEY:-$CERTS/server-rsa-sign.key}"
RSA_ENC_CERT="${RSA_ENC_CERT:-$CERTS/server-rsa-enc.crt}"
RSA_ENC_KEY="${RSA_ENC_KEY:-$CERTS/server-rsa-enc.key}"
CLIENT_SIGN_CERT="${CLIENT_SIGN_CERT:-$CERTS/client-rsa-sign.crt}"
CLIENT_SIGN_KEY="${CLIENT_SIGN_KEY:-$CERTS/client-rsa-sign.key}"
CLIENT_ENC_CERT="${CLIENT_ENC_CERT:-$CERTS/client-rsa-enc.crt}"
CLIENT_ENC_KEY="${CLIENT_ENC_KEY:-$CERTS/client-rsa-enc.key}"
